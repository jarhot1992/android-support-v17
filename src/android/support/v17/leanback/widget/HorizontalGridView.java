...
public class HorizontalGridView extends BaseGridView {
    ...
    protected void initAttributes(Context context, AttributeSet attrs) {
        ...
        // setRowHeight(a);
        // setNumRows(a.getInt(R.styleable.lbHorizontalGridView_numberOfRows,
        // 1));
        // a.recycle();
        updateLayerType();
    ...
    void setRowHeight(TypedArray array) {
        ...
        // array.peekValue(R.styleable.lbHorizontalGridView_rowHeight);
        // int size;
        // if (typedValue != null && typedValue.type ==
        // TypedValue.TYPE_DIMENSION) {
        // size =
        // array.getDimensionPixelSize(R.styleable.lbHorizontalGridView_rowHeight,
        // 0);
        // } else {
